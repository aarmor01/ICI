...
import es.ucm.fdi.ici.c2122.practica5.grupo02.mspacman.MsPacManCBRengine;
import es.ucm.fdi.ici.c2122.practica5.grupo02.mspacman.MsPacManInput;
...
public class MsPacMan extends PacmanController {
	...
	{		
		...
		cbrEngine = new MsPacManCBRengine(this.storageManager);
	}
