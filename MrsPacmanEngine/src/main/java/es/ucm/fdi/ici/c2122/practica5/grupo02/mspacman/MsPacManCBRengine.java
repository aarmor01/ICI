...
public class MsPacManCBRengine implements StandardCBRApplication {
	...
	final static String CASE_BASE_PATH = "src" + File.separator + "main" + File.separator + "java" + File.separator
			+ "es" + File.separator + "ucm" + File.separator + "fdi" + File.separator + "ici" + File.separator + "c2122"
			+ File.separator + "practica5" + File.separator + TEAM + File.separator + "cbrdata" + File.separator
